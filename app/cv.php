    ...
    <main>
        <div class="container">
            ...
            <div class="button-group">
                <a href="func/create_cv.php" class="button create-button">Créer un nouveau CV</a>
            </div>
            <div class="cv-list">
                <?php if (count($cvs) > 0): ?>
                    <?php foreach ($cvs as $cv): ?>
                        <div class="cv-item">
                            ...
                            <a href="func/view_single_cv.php?id=<?= $cv['id'] ?>" class="button view-button">Voir ce CV</a>
                        </div>
                    <?php endforeach; ?>
                <?php else: ?>
